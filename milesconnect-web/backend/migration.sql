...
CREATE TABLE "TripSheet" (
    ...
    "fuelAtStart" DOUBLE PRECISION,
    "fuelAtEnd" DOUBLE PRECISION,
    "currency" TEXT NOT NULL DEFAULT 'INR',
    "fuelExpenseCents" BIGINT NOT NULL DEFAULT 0,
    "tollExpenseCents" BIGINT NOT NULL DEFAULT 0,
    "otherExpenseCents" BIGINT NOT NULL DEFAULT 0,
    "totalExpenseCents" BIGINT NOT NULL DEFAULT 0,
    "notes" TEXT,
    "managerApprovedById" UUID,
